...
int main(int argc, char* argv[]){
    _asm
	{
		...
		_emit(0x56)
		_emit(0x78)
		//b3对于偏移b0，在执行之前在全局描述符表b0偏移处设置门描述符
		_emit(0xb3)
		_emit(0x00)
	}
...
在函数调用前下个断电，`F5`编译运行代码后获取函数的入口地址，获取到fun的入口地址`0x0040100a`
...
![image-20220412193946411](/images/image-20220412193946411.png)
